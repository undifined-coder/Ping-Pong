...
(function () {
    ...
    if (rod === "null" || maxScore === "null") {
        alert("This is the first time you are playing this game. LET'S START PRESS ENTER PRESS 'A' TO GO LEFT AND 'D' TO GO RIGHT");
        maxScore = 0;
        rod = "Rod1"
    } else {
        alert(rod + " has maximum score of " + maxScore * 100+"     "+"PRESS ENTER TO START PRESS 'A' TO GO LEFT AND 'D' TO GO RIGHT");
    }
